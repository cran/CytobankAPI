...
# Update channels
channels_vector <- c(2, 3, 5, 8)
SPADE_object@channels <- channels_vector
...
1. group_name: The group that each file is associated with
    ...
    * Each file must be associated with a group, if any file is 'Unassigned', the CITRUS analysis cannot be ran
